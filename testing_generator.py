                ...
                with open(path + '/DeviceLogA2_'+ datetime.now().strftime("%Y-%m-%d_%H%M%S") + '.log', 'w+', newline = '') as file4:
                    with open(path + '/DeviceLogA3_'+ datetime.now().strftime("%Y-%m-%d_%H%M%S") + '.log', 'w+', newline = '') as file5:
                        with open(path + '/DeviceLogA4_'+ datetime.now().strftime("%Y-%m-%d_%H%M%S") + '.log', 'w+', newline = '') as file6:
                                ...
                                if runs == 1:
                                    ...
                                    while count < 100:
                                        ...
                                        for x in seconds:
                                            ...
                                            DeviceLogA1.writerow([datetime.now() + timedelta(seconds=x), "Device NodeID A000001 Sending Hello World " + str(count)])
                                            DeviceLogA3.writerow([datetime.now() + timedelta(seconds=x), "Device NodeID A000003 Sending Hello World " + str(count)])
                                            DeviceLogA5.writerow([datetime.now() + timedelta(seconds=x), "Device NodeID A000005 Sending Hello World " + str(count)])
                                            ...
                                            if count != random.randint(51,101):
                                                DeviceLogA2.writerow([datetime.now() + timedelta(seconds=x), "Device NodeID A000002 Sending Hello World " + str(count)])
                                                DeviceLogA4.writerow([datetime.now() + timedelta(seconds=x), "Device NodeID A000004 Sending Hello World " + str(count)])
                                            ...
                                            #Create App Logs
                                            AppReport.writerow([datetime.now() + timedelta(seconds=x), "A000001", "Cloud App Received Hello World " + str(count)])
                                            AppReport.writerow([datetime.now() + timedelta(seconds=x), "A000002", "Cloud App Received Hello World " + str(count)])
                                            AppReport.writerow([datetime.now() + timedelta(seconds=x), "A000003", "Cloud App Received Hello World " + str(count)])
                                            if count == random.randint(1,50):
                                                AppReport.writerow([datetime.now() + timedelta(seconds=x), "A000002", "Cloud App Received Hello World " + str(count)])
                                                AppReport.writerow([datetime.now() + timedelta(seconds=x), "A000003", "Cloud App Received Hello World " + str(count)])
                                            if count != random.randint(51,101):
                                                AppReport.writerow([datetime.now() + timedelta(seconds=x), "A000004", "Cloud App Received Hello World " + str(count)])
                                                AppReport.writerow([datetime.now() + timedelta(seconds=x), "A000005", "Cloud App Received Hello World " + str(count)])
                                            # time.sleep(1)
                            ...
                            print("Commencing 5 Second Wait")  
                            time.sleep(5)
