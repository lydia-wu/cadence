...
var _strict_keys_rt = require("@kbn/io-ts-utils/strict_keys_rt");
...
function decodeRequestParams(params, paramsRt) {
  const paramMap = (0, _lodash.omitBy)({
    ...
    body: params.body,
    query: params.query
  }, val => val === null || val === undefined || (0, _lodash.isPlainObject)(val) && (0, _lodash.isEmpty)(val)); // decode = validate
