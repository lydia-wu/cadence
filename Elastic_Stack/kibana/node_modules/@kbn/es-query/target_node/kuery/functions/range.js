...
function buildNodeParams(fieldName, params) {
  const paramsToMap = (0, _lodash.pick)(params, 'gt', 'lt', 'gte', 'lte', 'format');
  ...
  const args = (0, _lodash.map)(paramsToMap, (value, key) => {
...
function toElasticsearchQuery(node, indexPattern, config = {}, context = {}) {
  ...
  const queryParams = (0, _lodash.mapValues)(namedArgs, arg => {
