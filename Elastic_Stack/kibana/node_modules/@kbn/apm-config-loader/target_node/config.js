...
class ApmConfiguration {
  ...
  getBaseConfig() {
    if (!this.baseConfig) {
      ...
      }, DEFAULT_CONFIG, this.getUuidConfig(), this.getGitConfig(), this.getCiConfig(), this.getConfigFromKibanaConfig(), this.getDevConfig(), this.getConfigFromEnv());
      /**
  ...
  getDevConfig() {
    ...
    try {
      const apmDevConfigPath = (0, _path.join)(this.rootDir, 'config', 'apm.dev.js');
