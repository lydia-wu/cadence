 ...
 */.euiBreadcrumbs__list{font-size:14px;font-size:.875rem;line-height:1.5;-webkit-flex-wrap:wrap;flex-wrap:wrap;min-width:0;margin-bottom:-4px
 ...
 */.euiDatePickerRange{max-width:400px;width:100%;height:auto;background-color:#16171c;background-repeat:no-repeat;background-size:0 100%;box-shadow:0 1px 1px -1px rgba(0,0,0,.2),0 3px 2px -2px rgba(0,0,0,.2),inset 0 0 0 1px hsla(0,0%,100%,.1);transition:box-shadow .15s ease-in,background-image .15s ease-in,background-size .15s ease-in,background-color .15s ease-in;display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center;padding:1px
 ...
 */.euiSideNavItemButton{font-size:14px;font-size:.875rem;line-height:1.5;text-align:left;
  ...
  /* 2 */}.euiSideNavItemButton.euiSideNavItemButton--isClickable:not(:disabled):hover{cursor:pointer}.euiSideNavItemButton.euiSideNavItemButton--isClickable:not(:disabled):focus .euiSideNavItemButton__label,.euiSideNavItemButton.euiSideNavItemButton--isClickable:not(:disabled):hover .euiSideNavItemButton__label{text-decoration:underline
    /* 4 */}.euiSideNavItemButton.euiSideNavItemButton-isSelected{color:#1ba9f5;font-weight:700}.euiSideNavItemButton.euiSideNavItemButton-isSelected .euiSideNavItemButton__label{text-decoration:underline
      /* 4 */}.euiSideNavItemButton:disabled{cursor:not-allowed;text-decoration:none;color:#55575a}.euiSideNavItemButton__content{display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center}.euiSideNavItemButton__icon{margin-right:8px}.euiSideNavItemButton__labelContainer{min-width:0
...
/**
  ...
  */.euiToast__closeButton{position:absolute;top:16px;right:16px;line-height:0;
  /* 1 */-webkit-appearance:none;-moz-appearance:none;appearance:none;opacity:0;transition:opacity .15s cubic-bezier(.694,.0482,.335,1)}.euiToast__closeButton svg{fill:#434548}.euiToast__closeButton:hover svg{fill:#dfe5ef}.euiToast__closeButton:focus{background-color:#052231;opacity:1}.euiToast__closeButton:focus svg{fill:#1ba9f5}.euiToast--primary{border-top:2px solid #1ba9f5}.euiToast--success{border-top:2px solid #7de2d1}.euiToast--warning{border-top:2px solid #ffce7a}.euiToast--danger{border-top:2px solid #f66}
...
/**
  ...
  */.euiToastHeader__icon{-webkit-flex:0 0 auto;flex:0 0 auto;fill:#dfe5ef;-webkit-transform:translateY(2px);transform:translateY(2px)
  /* 1 */}.euiToastHeader__title{overflow-wrap:break-word!important;word-wrap:break-word!important;word-break:break-word;color:#dfe5ef;font-size:16px;font-size:1rem;line-height:1.5rem;font-weight:600;letter-spacing:-.02em;font-weight:300}.euiToastHeader--withBody{margin-bottom:8px}
