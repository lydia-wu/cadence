...
function renderTitle(ctx, panel, _a) {
    var _b = _a.size, width = _b.width, height = _b.height, _c = _a.dimension, maxLabelBboxWidth = _c.maxLabelBboxWidth, maxLabelBboxHeight = _c.maxLabelBboxHeight, _d = _a.axisSpec, position = _d.position, hideAxis = _d.hide, title = _d.title, _e = _a.axisStyle, axisPanelTitle = _e.axisPanelTitle, axisTitle = _e.axisTitle, tickLabel = _e.tickLabel, tickLine = _e.tickLine, panelTitle = _a.panelTitle, debug = _a.debug, anchorPoint = _a.anchorPoint;
    ...
    var allLayersGirth = (0, axis_utils_1.getAllAxisLayersGirth)(tickLabel, maxLabelBoxGirth, horizontal);
