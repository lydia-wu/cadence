...
function formatStackedDataSeriesValues(dataSeries, xValues, stackMode) {
    ...
    var stackAsPercentage = stackMode === specs_1.StackMode.Percentage;
    ...
    dataSeries.forEach(function (_a) {
        ...
        data.forEach(function (d) {
            ...
            reorderedArray[xIndex][key + "-y0"] = (0, common_1.isFiniteNumber)(y0) ? (stackAsPercentage ? Math.abs(y0) : y0) : y0;
            var nonNullY1 = y1 !== null && y1 !== void 0 ? y1 : 0;
            var nonNullY0 = y0 !== null && y0 !== void 0 ? y0 : 0;
