...
exports.getSeriesIdentifierFromDataSeries = exports.getSeriesColors = exports.getSeriesName = exports.isDataSeriesBanded = exports.getDataSeriesFromSpecs = exports.getFormattedDataSeries = exports.extractYAndMarkFromDatum = exports.getSeriesKey = exports.splitSeriesDataByAccessors = exports.getAccessorFieldName = exports.getSeriesIndex = exports.SERIES_DELIMITER = void 0;
...
function getFormattedDataSeries(seriesSpecs, availableDataSeries, xValues, xScaleType) {
    ...
    var fittedAndStackedDataSeries = stackedGroups.reduce(function (acc, dataSeries) {
        var _a = __read(dataSeries, 1), stackMode = _a[0].stackMode;
        var formatted = (0, stacked_series_utils_1.formatStackedDataSeriesValues)(dataSeries, xValues, stackMode);
...
function isDataSeriesBanded(_a) {
    var spec = _a.spec;
    return spec.y0Accessors && spec.y0Accessors.length > 0;
}
exports.isDataSeriesBanded = isDataSeriesBanded;
