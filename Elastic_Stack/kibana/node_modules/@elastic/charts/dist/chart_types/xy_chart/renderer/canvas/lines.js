...
function renderLine(ctx, line, sharedStyle, clippings, highlightedLegendItem) {
    ...
    var stroke = (0, line_1.buildLineStyles)(color, seriesLineStyle, geometryStyle);
    (0, path_1.renderLinePaths)(ctx, transform, [line.line], stroke, clippedRanges, clippings, hideClippedRanges);
}
