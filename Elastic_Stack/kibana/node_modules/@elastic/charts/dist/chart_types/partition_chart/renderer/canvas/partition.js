...
var PartitionComponent = (function (_super) {
    ...
    PartitionComponent.prototype.render = function () {
        var _a = this.props, forwardStageRef = _a.forwardStageRef, initialized = _a.initialized, _b = _a.chartContainerDimensions, width = _b.width, height = _b.height, a11ySettings = _a.a11ySettings, debug = _a.debug, isRTL = _a.isRTL;
    ...
    PartitionComponent.prototype.drawCanvas = function () {
        ...
        if (this.ctx) {
            ...
            props_1.multiGeometries.forEach(function (geometries, geometryIndex) {
                var renderer = (0, viewmodel_1.isSimpleLinear)(geometries.config, geometries.layers)
                    ? canvas_linear_renderers_1.renderLinearPartitionCanvas2d
                    : (0, viewmodel_1.isWaffle)(geometries.config.partitionLayout)
