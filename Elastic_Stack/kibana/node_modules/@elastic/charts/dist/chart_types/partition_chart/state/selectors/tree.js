...
function getTreesForSpec(spec, smSpecs, groupBySpecs) {
    var _a, _b, _c, _d;
    var data = spec.data, valueAccessor = spec.valueAccessor, layers = spec.layers, config = spec.config, smId = spec.smallMultiples;
    ...
    if (groupBySpec) {
        ...
        return __spreadArray([], __read(groups), false).sort((0, predicate_1.getPredicateFn)(sort)).map(function (_a, innerIndex) {
            ...
            return ({
                ...
                style: smStyle,
                tree: (0, hierarchy_of_arrays_1.partitionTree)(subData, valueAccessor, layers, config_1.configMetadata.partitionLayout.dflt, config.partitionLayout, [
        ...
        return [
            {
                ...
                smAccessorValue: '',
                style: smStyle,
                tree: (0, hierarchy_of_arrays_1.partitionTree)(data, valueAccessor, layers, config_1.configMetadata.partitionLayout.dflt, config.partitionLayout, [
                    {
                        index: 0,
