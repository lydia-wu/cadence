...
exports.partitionMultiGeometries = (0, create_selector_1.createCustomCachedSelector)([get_settings_specs_1.getSpecs, get_partition_specs_1.getPartitionSpecs, get_chart_container_dimensions_1.getChartContainerDimensionsSelector, tree_1.getTrees, get_chart_theme_1.getChartThemeSelector], function (specs, partitionSpecs, parentDimensions, trees, _a) {
    var background = _a.background, axisPanelTitle = _a.axes.axisPanelTitle;
    ...
    var result = partitionSpecs.flatMap(function (spec, index) {
        ...
        return trees.map(function (_a, innerIndex, a) {
            ...
            return (0, scenegraph_1.getShapeViewModel)(spec, parentDimensions, t, background.color, style, {
                index: index,
                innerIndex: innerIndex,
                partitionLayout: (_c = spec.config.partitionLayout) !== null && _c !== void 0 ? _c : config_1.config.partitionLayout,
    ...
    return result.length === 0 ? [(0, viewmodel_types_1.nullShapeViewModel)(config_1.config, { x: outerWidthRatio, y: outerHeightRatio })] : result;
});
