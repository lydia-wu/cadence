...
var HighlighterComponent = (function (_super) {
    ...
    HighlighterComponent.prototype.renderAsMask = function () {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("defs", null, renderedHighlightSet
                ...
                .map(function (_a) {
                var geometries = _a.geometries, geometriesFoci = _a.geometriesFoci, diskCenter = _a.diskCenter, index = _a.index, innerIndex = _a.innerIndex, partitionLayout = _a.partitionLayout, marginLeftPx = _a.marginLeftPx, marginTopPx = _a.marginTopPx, _b = _a.panel, innerWidth = _b.innerWidth, innerHeight = _b.innerHeight;
                return (react_1.default.createElement("mask", { key: maskId(index, innerIndex), id: maskId(index, innerIndex) },
                    ...
                    react_1.default.createElement("g", { transform: "translate(" + diskCenter.x + ", " + diskCenter.y + ")" }, renderGeometries(geometries, partitionLayout, { color: colors_1.Colors.Black.keyword }, geometriesFoci, width))));
            })),
            renderedHighlightSet.map(function (_a) {
                var diskCenter = _a.diskCenter, outerRadius = _a.outerRadius, index = _a.index, innerIndex = _a.innerIndex, partitionLayout = _a.partitionLayout, marginLeftPx = _a.marginLeftPx, marginTopPx = _a.marginTopPx, _b = _a.panel, innerWidth = _b.innerWidth, innerHeight = _b.innerHeight;
                return (0, viewmodel_1.isSunburst)(partitionLayout) ? (react_1.default.createElement("circle", { key: index + "__" + innerIndex, cx: diskCenter.x, cy: diskCenter.y, r: outerRadius, mask: "url(#" + maskId(index, innerIndex) + ")", className: "echHighlighter__mask" })) : (react_1.default.createElement("rect", { key: index + "__" + innerIndex, x: marginLeftPx, y: marginTopPx, width: innerWidth, height: innerHeight, mask: "url(#" + maskId(index, innerIndex) + ")", className: "echHighlighter__mask" }));
            })));
    };
    HighlighterComponent.prototype.renderAsOverlay = function () {
        ...
        return this.props.highlightSets
            ...
            .map(function (_a) {
            var index = _a.index, innerIndex = _a.innerIndex, partitionLayout = _a.partitionLayout, geometries = _a.geometries, diskCenter = _a.diskCenter, geometriesFoci = _a.geometriesFoci;
            return (react_1.default.createElement("g", { key: index + "|" + innerIndex, transform: "translate(" + diskCenter.x + ", " + diskCenter.y + ")" }, renderGeometries(geometries, partitionLayout, {
...
exports.DEFAULT_PROPS = {
    ...
    highlightSets: [
        __assign(__assign({}, (0, viewmodel_types_1.nullPartitionSmallMultiplesModel)(config_1.configMetadata.partitionLayout.dflt)), { geometries: [], geometriesFoci: [], diskCenter: {
                x: 0,
                y: 0,
            }, outerRadius: 10 }),
    ],
