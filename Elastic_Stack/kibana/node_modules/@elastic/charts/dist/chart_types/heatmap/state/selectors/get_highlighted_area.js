...
exports.getHighlightedAreaSelector = (0, create_selector_1.createCustomCachedSelector)([geometries_1.geometries, get_heatmap_spec_1.getHeatmapSpecSelector, is_brushing_1.isBrushingSelector], function (geoms, spec, isBrushing) {
    if (!spec.highlightedData || isBrushing) {
        return null;
    }
