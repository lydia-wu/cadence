...
var Component = (function (_super) {
    ...
    Component.prototype.drawCanvas = function () {
        if (this.ctx) {
            ...
            (0, canvas_renderers_1.renderCanvas2d)(this.ctx, this.devicePixelRatio, __assign(__assign({}, this.props.geometries), { config: __assign(__assign({}, this.props.geometries.config), { width: width, height: height }) }), this.props.background);
        }
    };
