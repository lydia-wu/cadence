...
exports.defaultGoalSpec = __assign(__assign({}, commonDefaults), { bands: [50, 75, 100], bandFillColor: function (_a) {
    ...
    }, bandLabels: [], angleStart: Math.PI + Math.PI / 4, angleEnd: -Math.PI / 4 });
exports.nullGoalViewModel = __assign(__assign({}, commonDefaults), { bands: [], ticks: [], labelMajor: '', labelMinor: '', centralMajor: '', centralMinor: '', highestValue: 100, lowestValue: 0, aboveBaseCount: 0, belowBaseCount: 0, angleStart: 0, angleEnd: 0 });
