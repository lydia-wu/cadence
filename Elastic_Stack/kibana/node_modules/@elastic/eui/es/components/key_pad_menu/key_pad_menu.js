...
export var EuiKeyPadMenu = function EuiKeyPadMenu(_ref) {
  ...
  var legend = _typeof(checkable) === 'object' && checkable.legend ? /*#__PURE__*/React.createElement(EuiFormLabel, _extends({}, checkable.legendProps, {
    type: "legend"
  }), checkable.legend) : undefined;
  return checkable ? /*#__PURE__*/React.createElement("fieldset", _extends({
    className: classes,
    "aria-label": _typeof(checkable) === 'object' ? checkable.ariaLegend : undefined
  }, rest), legend, children) : /*#__PURE__*/React.createElement("ul", _extends({
    className: classes
