...
var EuiPagination = function EuiPagination(_ref) {
  ...
  for (var i = firstPageInRange, index = 0; i < lastPageInRange; i++, index++) {
    pages.push( /*#__PURE__*/_react.default.createElement(PaginationButtonWrapper, _extends({
      pageIndex: i,
      key: i
    }, sharedButtonProps)));
  }
  ...
  if (firstPageInRange > 0) {
    firstPageButtons.push( /*#__PURE__*/_react.default.createElement(PaginationButtonWrapper, _extends({
      pageIndex: 0,
      key: 0
    }, sharedButtonProps)));
  ...
  if (lastPageInRange < pageCount) {
    if (lastPageInRange + 1 === pageCount - 1) {
      lastPageButtons.push( /*#__PURE__*/_react.default.createElement(PaginationButtonWrapper, _extends({
  ...
  if (compressed) {
    var firstPageButtonCompressed = /*#__PURE__*/_react.default.createElement(PaginationButtonWrapper, _extends({
      pageIndex: activePage,
      inList: false
    }, sharedButtonProps));

    var lastPageButtonCompressed = /*#__PURE__*/_react.default.createElement(PaginationButtonWrapper, _extends({
      pageIndex: pageCount - 1,
      inList: false
    }, sharedButtonProps));
