...
var EuiPagination = function EuiPagination(_ref) {
  ...
  for (var i = firstPageInRange, index = 0; i < lastPageInRange; i++, index++) {
    pages.push( /*#__PURE__*/_react.default.createElement(PaginationButtonWrapper, (0, _extends2.default)({
      pageIndex: i,
      key: i
    }, sharedButtonProps)));
  }
  ...
  if (firstPageInRange > 0) {
    firstPageButtons.push( /*#__PURE__*/_react.default.createElement(PaginationButtonWrapper, (0, _extends2.default)({
      pageIndex: 0,
      key: 0
    }, sharedButtonProps)));
  ...
  if (lastPageInRange < pageCount) {
    if (lastPageInRange + 1 === pageCount - 1) {
      lastPageButtons.push( /*#__PURE__*/_react.default.createElement(PaginationButtonWrapper, (0, _extends2.default)({
  ...
  if (compressed) {
    var firstPageButtonCompressed = /*#__PURE__*/_react.default.createElement(PaginationButtonWrapper, (0, _extends2.default)({
      pageIndex: activePage,
      inList: false
    }, sharedButtonProps));

    var lastPageButtonCompressed = /*#__PURE__*/_react.default.createElement(PaginationButtonWrapper, (0, _extends2.default)({
      pageIndex: pageCount - 1,
      inList: false
    }, sharedButtonProps));
...
var PaginationButtonWrapper = function PaginationButtonWrapper(_ref2) {
  ...
  var button = /*#__PURE__*/_react.default.createElement(_pagination_button.EuiPaginationButton, {
