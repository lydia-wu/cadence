...
exports.getSnapshotSearchWildcard = void 0;
/*
...
const getSnapshotSearchWildcard = ({
  field,
  value,
  match,
  operator
  ...
  value = operator === 'exact' ? value : `*${value}*`; // ES API new "-"("except") wildcard removes matching items from a list of already selected items
...
exports.getSnapshotSearchWildcard = getSnapshotSearchWildcard;