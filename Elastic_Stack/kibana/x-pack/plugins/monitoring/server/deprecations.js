...
const deprecations = ({
  ...
  return [deprecate('enabled', '8.0.0', {
    level: 'critical'
  }), deprecate('cluster_alerts.allowedSpaces', '8.0.0', {
    level: 'warning',
    message: _i18n.i18n.translate('xpack.monitoring.deprecations.allowedSpaces', {
      defaultMessage: 'Starting in 7.15, the Stack Monitoring application will prompt you to create cluster alerts rather than creating them automatically in allowed spaces.' + ' This configuration is no longer used and will be removed in a future version. '
    })
