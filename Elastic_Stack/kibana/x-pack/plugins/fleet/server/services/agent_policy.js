...
class AgentPolicyService {
  ...
  async copy(soClient, esClient, id, newAgentPolicyProps, options) {
    ...
    const newAgentPolicy = await this.create(soClient, esClient, {
      ...
      monitoring_enabled,
      ...newAgentPolicyProps
    }, options); // Copy all package policies and append (copy) to their names
...
async function addPackageToAgentPolicy(soClient, esClient, packageToInstall, agentPolicy, defaultOutput, packagePolicyName, packagePolicyId, packagePolicyDescription, transformPackagePolicy) {
