...
var _get_is_using_transaction_events = require("../lib/helpers/aggregated_transactions/get_is_using_transaction_events");
...
const fallbackToTransactionsRouteRepository = (0, _create_apm_server_route_repository.createApmServerRouteRepository)().add(fallbackToTransactionsRoute);
