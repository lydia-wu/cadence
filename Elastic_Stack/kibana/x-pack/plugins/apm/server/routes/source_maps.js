...
const sourceMapsRouteRepository = (0, _create_apm_server_route_repository.createApmServerRouteRepository)().add(listSourceMapRoute).add(uploadSourceMapRoute).add(deleteSourceMapRoute);
