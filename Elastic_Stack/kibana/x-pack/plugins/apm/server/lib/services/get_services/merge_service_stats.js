...
function mergeServiceStats({
  ...
  return (0, _join_by_key.joinByKey)((0, _as_mutable_array.asMutableArray)([...transactionStats, ...servicesFromMetricDocuments, ...matchedHealthStatuses]), 'serviceName', function merge(a, b) {
