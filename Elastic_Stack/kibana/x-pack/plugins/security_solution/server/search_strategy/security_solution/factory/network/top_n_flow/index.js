...
exports.networkTopNFlowEntities = exports.networkTopNFlow = void 0;
...
var _queryTop_n_flow_network_entities = require("./query.top_n_flow_network_entities.dsl");
/*
...
const networkTopNFlowEntities = {
  buildDsl: options => {
    if (options.pagination && options.pagination.querySize >= _constants.DEFAULT_MAX_TABLE_QUERY_SIZE) {
      throw new Error(`No query size above ${_constants.DEFAULT_MAX_TABLE_QUERY_SIZE}`);
    }

    return (0, _queryTop_n_flow_network_entities.buildTopNFlowQueryEntities)(options);
  },
  parse: async (options, response) => {
    const {
      activePage,
    ...
    const edges = networkTopNFlowEdges.splice(cursorStart, querySize - cursorStart);
    const inspect = {
      dsl: [(0, _build_query.inspectStringifyObject)((0, _queryTop_n_flow_network_entities.buildTopNFlowQueryEntities)(options))]
    };
    const showMorePagesIndicator = totalCount > fakeTotalCount;
    return { ...response,
      edges,
...
exports.networkTopNFlowEntities = networkTopNFlowEntities;