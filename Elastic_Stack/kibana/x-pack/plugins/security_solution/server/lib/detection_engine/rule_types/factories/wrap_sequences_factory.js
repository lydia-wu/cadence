...
const wrapSequencesFactory = ({
  ...
  mergeStrategy,
  spaceId
}) => (sequences, buildReasonMessage) => sequences.reduce((acc, sequence) => [...acc, ...(0, _build_alert_group_from_sequence.buildAlertGroupFromSequence)(logger, sequence, ruleSO, mergeStrategy, spaceId, buildReasonMessage)], []);
