...
const updateMigrationSavedObject = async ({
  ...
  return (0, _pipeable.pipe)(attributes, attrs => (0, _securitysolutionIoTsUtils.validateTaskEither)(_saved_objects_schema.signalsMigrationSOUpdateAttributes, attrs), (0, _TaskEither.chain)(validAttrs => (0, _TaskEither.tryCatch)(() => client.update(id, { ...validAttrs,
