...
const legacyExtractReferences = ({
  ...
  const returnReferences = [...legacyRuleIdReferences]; // Modify params if you want to remove any elements separately here. For legacy ruleAlertId, we do not remove the id and instead
