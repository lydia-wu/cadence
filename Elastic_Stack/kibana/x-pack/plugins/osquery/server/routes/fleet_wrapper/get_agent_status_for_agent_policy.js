...
const getAgentStatusForAgentPolicyRoute = (router, osqueryContext) => {
  router.get({
    ...
    const results = await ((_osqueryContext$servi = osqueryContext.service.getAgentService()) === null || _osqueryContext$servi === void 0 ? void 0 : _osqueryContext$servi.getAgentStatusForAgentPolicy(esClient, request.query.policyId, request.query.kuery));
