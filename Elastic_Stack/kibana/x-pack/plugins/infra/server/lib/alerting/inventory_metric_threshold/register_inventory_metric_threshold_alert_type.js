...
var _types2 = require("../../../../common/inventory_models/types");
...
const condition = _configSchema.schema.object({
  ...
  metric: (0, _utils.oneOfLiterals)(Object.keys(_types2.SnapshotMetricTypeKeys)),
...
async function registerMetricInventoryThresholdAlertType(alertingPlugin, libs) {
