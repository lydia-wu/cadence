...
exports.isClaimOwnershipResult = exports.TaskClaiming = void 0;
...
class TaskClaiming {
  ...
  async markAvailableTasksAsClaimed({
    ...
    const apmTrans = _elasticApmNode.default.startTransaction('markAvailableTasksAsClaimed', `taskManager markAvailableTasksAsClaimed`);
