...
const rulesRouteRepository = (0, _create_observability_server_route_repository.createObservabilityServerRouteRepository)().add(alertsDynamicIndexPatternRoute);
