...
function getStats({
  ...
  const stats = { ...(kibanaRequest.query ? {
    ...
    indexPattern: {
      label: _i18n.i18n.translate('xpack.observability.inspector.stats.indexPatternLabel', {
        defaultMessage: 'Index pattern'
      }),
      value: esRequestParams.index,
      description: _i18n.i18n.translate('xpack.observability.inspector.stats.indexPatternDescription', {
