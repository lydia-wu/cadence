...
function getExportTypesRegistry() {
  ...
  const getTypeFns = [_csv_searchsource.getExportType, _csv.getExportType, _csv_searchsource_immediate.getExportType, _png.getExportType, _png_v.getExportType, _printable_pdf.getExportType, _printable_pdf_v.getExportType];
