...
function getSessionConfig(session, providers) {
  ...
  return {
    ...
    getExpirationTimeouts(provider) {
      var _providerSessionConfi, _providerSessionConfi2, _providerSessionConfi3; // Both idle timeout and lifespan from the provider specific session config can have three
      ...
      const providerLifespan = (provider === null || provider === void 0 ? void 0 : provider.type) === 'anonymous' && ((_providerSessionConfi = providerSessionConfig) === null || _providerSessionConfi === void 0 ? void 0 : _providerSessionConfi.lifespan) === undefined && session.lifespan === undefined ? defaultAnonymousSessionLifespan : (_providerSessionConfi2 = providerSessionConfig) === null || _providerSessionConfi2 === void 0 ? void 0 : _providerSessionConfi2.lifespan;
      const [idleTimeout, lifespan] = [[session.idleTimeout, (_providerSessionConfi3 = providerSessionConfig) === null || _providerSessionConfi3 === void 0 ? void 0 : _providerSessionConfi3.idleTimeout], [session.lifespan, providerLifespan]].map(([globalTimeout, providerTimeout]) => {
