      ...
      return [{
        ...
        correctiveActions: {
          manualSteps: [_i18n.i18n.translate('dataViews.deprecations.scriptedFields.manualStepOneMessage', {
            ...
            defaultMessage: 'Update {numberOfIndexPatternsWithScriptedFields} index patterns that have scripted fields to use runtime fields instead. In most cases, to migrate existing scripts, you will need to change "return <value>;" to "emit(<value>);". Index patterns with at least one scripted field: {allTitles}',
            values: {
