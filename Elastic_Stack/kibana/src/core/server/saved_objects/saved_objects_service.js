...
var _delete_index_templates = require("./service/lib/delete_index_templates");
  ...
  async start({
    ...
    if (skipMigrations) {
      ...
      if (compatibleNodes) {
        ...
        await (0, _delete_index_templates.deleteIndexTemplates)({
          client: client.asInternalUser,
          log: this.logger
        });
