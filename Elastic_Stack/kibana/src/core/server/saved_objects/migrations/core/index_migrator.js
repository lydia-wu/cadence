...
async function migrateSourceToDest(context) {
  ...
  while (true) {
    ...
    await Index.write(client, dest.indexName, // @ts-expect-error @elastic/elasticsearch _source is optional
    await (0, _migrate_raw_docs.migrateRawDocs)(serializer, documentMigrator.migrateAndConvert, docs));
  }
}