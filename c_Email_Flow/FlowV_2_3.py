...
#last edited by Lydia Wu @10:30PM, 2022-03-30
    ...
    try:
        ...
        while (True):
            ...
            for documentName in dir_list:
                ...
                notArchiveFile     = (len(documentName.split('archive'))     - 1 == 0)

                if (notHEARTBEATFile & notLookupTableFile & notArchiveFile) :
            ...
            for documentName in dir_list:
                ...
                if (notEmailFlowHEARTBEATFile & isOtherHEARTBEATFile):
                    filesim.append(directory+"/"+documentName)
                    print("Grabbing: ", documentName)
                    filecount = filecount + 1
