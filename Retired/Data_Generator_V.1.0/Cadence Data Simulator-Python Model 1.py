...
Redirect = sys.stdout
sys.stdout = open("/Users/Hunter/Downloads/Source 1.csv", "w+")
...
df = pandas.read_csv("/Users/Hunter/Downloads/Source 1.csv",
index_col='NodeID', 
header=0,
names=['Time','ICCID(SIM ID)', 'NodeID', 'Connection'])
df.to_csv('/Users/Hunter/Downloads/Source 1.csv')
